...
<head>
    ...
    <link rel=stylesheet href="${staticPath }/static/jQueryGantt/platform.css" type="text/css">
    <link rel=stylesheet href="${staticPath }/static/jQueryGantt/libs/jquery/dateField/jquery.dateField.css"
          type="text/css">
    <link rel="stylesheet" type="text/css" href="${staticPath }/static/foundation-icons/foundation-icons.css"/>

    <link rel=stylesheet href="${staticPath }/static/jQueryGantt/gantt.css" type="text/css">
    <link rel=stylesheet href="${staticPath }/static/jQueryGantt/ganttPrint.css" type="text/css" media="print">

    <script src="${staticPath }/static/jQueryGantt/libs/jquery-3.2.1/jquery-3.2.1.min.js"></script>
    <script src="${staticPath }/static/jQueryGantt/libs/jquery-ui-1.8.22/jquery-ui.min.js"></script>

    <script src="${staticPath }/static/jQueryGantt/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
    <script src="${staticPath }/static/jQueryGantt/libs/jquery/jquery.timers.js"></script>

    <script src="${staticPath }/static/jQueryGantt/libs/utilities.js"></script>
    <script src="${staticPath }/static/jQueryGantt/libs/forms.js"></script>
    <script src="${staticPath }/static/jQueryGantt/libs/date.js"></script>
    <script src="${staticPath }/static/jQueryGantt/libs/dialogs.js"></script>
    <script src="${staticPath }/static/jQueryGantt/libs/layout.js"></script>
    <script src="${staticPath }/static/jQueryGantt/libs/i18nJs.js"></script>
    <script src="${staticPath }/static/jQueryGantt/libs/jquery/dateField/jquery.dateField.js"></script>
    <script src="${staticPath }/static/jQueryGantt/libs/jquery/JST/jquery.JST.js"></script>

    <script type="text/javascript" src="${staticPath }/static/jQueryGantt/libs/jquery/svg/jquery.svg.min.js"></script>
    <script type="text/javascript"
            src="${staticPath }/static/jQueryGantt/libs/jquery/svg/jquery.svgdom.1.8.js"></script>


    <script src="${staticPath }/static/jQueryGantt/ganttUtilities.js"></script>
    <script src="${staticPath }/static/jQueryGantt/ganttTask.js"></script>
    <script src="${staticPath }/static/jQueryGantt/ganttDrawerSVG.js"></script>
    <script src="${staticPath }/static/jQueryGantt/ganttGridEditor.js"></script>
    <script src="${staticPath }/static/jQueryGantt/ganttMaster.js"></script>

    <%-- [EasyUI] --%>
    <link id="easyuiTheme" rel="stylesheet" type="text/css"
          href="${staticPath }/static/easyui/themes/bootstrap/easyui.css"/>
    ...
    <script type="text/javascript" src="${staticPath }/static/easyui/locale/easyui-lang-zh_CN.js"
...
<script type="text/javascript">
    ...
    function saveGanttOnServer() {
        ...
        /*
         ...
         //deletedTaskIds：是一个数组，包含已删除客户端的任务ID。只有具有“真实”ID的任务将被通知给服务器（因此不是以“tmp_”开头），本地生成的任务将被静默地删除。
...
<div id="gantEditorTemplates" style="display:none;">
  ...
  <div class="ganttButtonBar noprint">
    <div class="buttons">
     项目<select name="selectProject" id="selectProject" style="width:160px;margin: 10px 10px 10px 10px" ></select>  &nbsp; &nbsp; &nbsp; &nbsp;
    ...
    <button onclick='newProject();' class='button requireWrite newproject'><em>重置</em></button>
    <button class="button login" title="login/enroll" onclick="loginEnroll($(this));" style="display:none;">login/enroll</button>
    <button class="button opt collab" title="Start with Twproject" style="display:none;"><em>项目</em></button>
    </div></div>
  --></div>
  ...
  <table class="gdfTable" cellspacing="0" cellpadding="0">
    ...
    <tr style="height:40px">
      ...
      <th class="gdfColHeader"  align="center" style="width:20px;" title="计划开始里程碑"><span class="teamworkIcon" style="font-size: 8px;">^</span></th>
      <th class="gdfColHeader gdfResizable" style="width:80px;">计划开始时间</th>
      <th class="gdfColHeader"  align="center" style="width:20px;" title="计划结束里程碑"><span class="teamworkIcon" style="font-size: 8px;">^</span></th>
      <th class="gdfColHeader gdfResizable" style="width:80px;">计划结束时间</th>
      <th class="gdfColHeader gdfResizable" style="width:50px;">计划周期</th>
      <th class="gdfColHeader gdfResizable" style="width:20px;">计划完成百分比</th>
      <th class="gdfColHeader gdfResizable requireCanSeeDep" style="width:50px;">后置关系</th>
      <th class="gdfColHeader gdfResizable" style="width:1000px; text-align: left; padding-left: 10px;">任务执行人</th>
    </tr>
    </thead>
  </table>
  --></div>
  ...
  <tr taskId="(#=obj.id#)" class="taskEditRow (#=obj.isParent()?'isParent':''#) (#=obj.collapsed?'collapsed':''#)" level="(#=level#)">
    ...
    <td class="gdfCell"><input type="text" name="code" value="(#=obj.code?obj.code:''#)" placeholder="请输入计划编码"></td>
    <td class="gdfCell indentCell" style="padding-left:(#=obj.level*10+18#)px;">
      <div class="exp-controller" align="center"></div>
      <input type="text" name="name" value="(#=obj.name#)" placeholder="请输入计划名称">
    </td>
  ...
  <div class="ganttTaskEditor">
    ...
    <table  cellspacing="1" cellpadding="5" width="100%" class="taskData table" border="0">
      ...
      <tr class="dateRow">
        <td nowrap="">
          <div style="position:relative">
            ...
            <input type="checkbox" id="startIsMilestone" name="startIsMilestone" value="yes"> &nbsp;<label for="startIsMilestone">里程碑标志</label>&nbsp;
            <br><input type="text" name="start" id="start" size="8" class="formElements dateField validated date" autocomplete="off" maxlength="255" value="" oldvalue="1" entrytype="DATE">
            <span title="calendar" id="starts_inputDate" class="teamworkIcon openCalendar" onclick="$(this).dateField({inputField:$(this).prevAll(':input:first'),isSearchField:false});">m</span>          </div>
        </td>
        <td nowrap="">
          <label for="end">计划结束时间</label>&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="checkbox" id="endIsMilestone" name="endIsMilestone" value="yes"> &nbsp;<label for="endIsMilestone">里程碑标志</label>&nbsp;
          <br><input type="text" name="end" id="end" size="8" class="formElements dateField validated date" autocomplete="off" maxlength="255" value="" oldvalue="1" entrytype="DATE">
          <span title="calendar" id="ends_inputDate" class="teamworkIcon openCalendar" onclick="$(this).dateField({inputField:$(this).prevAll(':input:first'),isSearchField:false});">m</span>
        </td>
        <td nowrap="" >
          <label for="duration" class=" ">计划周期</label><br>
      ...
      <tr>
        <td  colspan="2">
          <label for="status" class=" ">计划状态</label><br>
          <select id="status" name="status" class="taskStatus" status="(#=obj.status#)"  onchange="$(this).attr('STATUS',$(this).val());">
            <option value="STATUS_ACTIVE" class="taskStatus" status="STATUS_ACTIVE" >启动</option>
            <option value="STATUS_SUSPENDED" class="taskStatus" status="STATUS_SUSPENDED" >暂停</option>
            <option value="STATUS_DONE" class="taskStatus" status="STATUS_DONE" >完结</option>
        ...
        <td valign="top" nowrap>
          ...
          <tr>
            <td colspan="4">
              <label for="description">计划明细</label><br>
  ...
  <table  cellspacing="1" cellpadding="0" width="100%" id="assigsTable">
    <tr>
      <th style="width:100px;">执行人名字</th>
      <th style="width:70px;">执行人角色</th>
...
<script type="text/javascript">
    ...
    $.JST.loadDecorator("ASSIGNMENT_ROW", function (assigTr, taskAssig) {
        ...
        //canWrite 是一个布尔值，表示如果您有权限在此项目上编写/更改/创建/删除任务。将其设置为true用于基本用法。
