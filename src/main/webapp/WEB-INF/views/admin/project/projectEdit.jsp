    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="projectEditForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>开发经理</td>
                    <td><select id="manager" name="manager"  style="width: 140px; height: 29px;"></select></td>
                    <td>上级项目</td>
                    <td><select id="pkParent" name="pkParent"  style="width: 140px; height: 29px;"></select></td>
                </tr>
                <tr>
                    <td>状态</td>
                    <td>
                        <select id="editStatus" name="status" value="${project.status}" class="easyui-combobox"
