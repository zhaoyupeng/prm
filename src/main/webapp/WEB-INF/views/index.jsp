...
<div id="index_layout">
    ...
    <div data-options="region:'south',border:false"
         style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee;color: #008ead;">Copyright ©
        2017 power by <a href="#" target="_blank" style="color: #008ead;text-decoration:none;">&nbsp;PRM &nbsp;APP</a>
    </div>
</div>
<div id="tabsMenu">
